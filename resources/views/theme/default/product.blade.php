        ...
        <div class="row g-5 align-items-start">
            <div class="col-md-6">
                <div class="bg-white shadow rounded p-3">
                    <img src="{{ $product->image_url ? asset('storage/' . $product->image_url) : 'https://via.placeholder.com/350x200?text=No+Image' }}" class="img-fluid rounded w-100" alt="{{ $product->name }}">
                </div>
                <div class="mt-3">
                    <span class="badge bg-secondary">
                        <i class="bi bi-tag-fill me-1"></i> {{ $product->category->name ?? 'Kategori Tidak Diketahui' }}
                    </span>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    <span class="fs-4 text-warning fw-semibold">Rp {{ number_format($product->price, 0, ',', '.') }}</span>
                    ...
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('product.show', $relatedProduct->slug) }}" class="btn btn-outline-primary btn-sm">
